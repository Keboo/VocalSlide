...
public class AutoAdvancePolicyTests
{
    ...
    public async Task Evaluate_WhenConfidenceIsBelowThreshold_DoesNotAdvance()
    {
        ...
        SlideSwitchEvaluation evaluation = new(4, 42, "The transcript only weakly matches the next slide.");
    ...
    {
        AutoAdvancePolicy policy = new();
        SlideSwitchEvaluation evaluation = new(3, 98, "The speaker is clearly on the next topic.");
    ...
    {
        AutoAdvancePolicy policy = new();
        SlideSwitchEvaluation evaluation = new(8, 99, "The evaluator jumped too far ahead.");
    ...
    {
        AutoAdvancePolicy policy = new();
        SlideSwitchEvaluation evaluation = new(5, 94, "The speaker has started discussing slide five.");
    ...
    {
        AutoAdvancePolicy policy = new();
        SlideSwitchEvaluation evaluation = new(2, 91, "The speaker returned to an earlier part of the deck.");
